  ...
  return (
    <div>
      <div className={styles.container}>
        ...
        <p className={styles.description}>This is the very begining & the focuses is only on corners of the system designs and enlist captured stats during those use cases. We would start with Mongo DB. Below are the stats</p>
